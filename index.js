...
app.post("/submit-form", async (req, res) => {
  ...
  <div style="max-width: 640px; margin: auto; background: #ffffff; border-radius: 12px; padding: 40px 30px; box-shadow: 0 8px 24px rgba(0, 0, 0, 0.05);">
    ...
    <div style="display: flex; align-items: center;">
      <img src="https://res.cloudinary.com/dfivgcj3i/image/upload/v1771677145/pixelcut-export_mnjxov_jmbgwq.webp" alt="Muazzam Hussain" style="width: 65px; height: 65px; border-radius: 50%; margin-right: 15px; border: 2px solid #e0e0e0;" />
      <div>
