...
// In your client-side JavaScript (e.g., assets/js/main.js)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (form) {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            sentMessageDiv.style.display = 'none'; // Hide sent message
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    loadingDiv.style.display = 'none';
                    errorMessageDiv.textContent = `Submission failed: ${errorText}`;
